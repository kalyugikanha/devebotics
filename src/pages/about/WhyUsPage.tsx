...
export default function WhyUsPage() {
  ...
  return (
    <main style={{ background: '#FFFFFF', minHeight: '100vh', paddingTop: 72, color: '#111827' }}>
      ...
      <section style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1, opacity: 0, animation: 'fadeInUp 1s ease-out forwards' }}>
          <div style={{ display: 'inline-block', border: '1px solid #E5E7EB', background: '#F9FAFB', padding: '8px 24px', borderRadius: 100, marginBottom: 40 }}>
            <span style={{ fontFamily: 'Lexend,sans-serif', fontSize: 12, color: '#1F8844', letterSpacing: '0.2em' }}>THE DEVBOTICS STANDARD</span>
          </div>
          <h1 style={{ fontFamily: 'Montserrat,sans-serif', fontWeight: 900, fontSize: 'clamp(48px, 8vw, 110px)', lineHeight: 0.95, letterSpacing: '-0.04em', marginBottom: 32 }}>
            ...
            <span style={{ color: '#E5E7EB', WebkitTextStroke: '2px #1F8844' }}>competitors fear.</span>
          </h1>
          <p style={{ fontFamily: 'Lexend,sans-serif', fontSize: 20, color: '#4B5563', maxWidth: 600, margin: '0 auto' }}>
      ...
      <section style={{ padding: '100px 0', background: '#F9FAFB', borderTop: '1px solid #E5E7EB', borderBottom: '1px solid #E5E7EB' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 40px', display: 'flex', gap: 80 }} className="sticky-layout">
          ...
          <div style={{ flex: '1 1 40%', position: 'relative' }} className="sticky-sidebar">
            <div style={{ position: 'sticky', top: 120 }}>
              <h2 style={{ fontFamily: 'Montserrat,sans-serif', fontWeight: 900, fontSize: 'clamp(40px, 5vw, 64px)', lineHeight: 1.1, marginBottom: 24 }}>
                The anatomy of<br />an <span style={{ color: '#1F8844' }}>unfair</span><br />advantage.
              </h2>
              <p style={{ fontFamily: 'Lexend,sans-serif', fontSize: 16, color: '#4B5563', lineHeight: 1.6, maxWidth: 400 }}>
          ...
          <div style={{ flex: '1 1 60%', display: 'flex', flexDirection: 'column', gap: 40, marginTop: 40 }}>
            {ADVANTAGES.map((adv, i) => (
              <div key={adv.num} style={{ background: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: 24, padding: 60, opacity: 0, animation: `fadeInRight 0.8s ease-out ${0.2 + (i * 0.1)}s forwards`, transition: 'all 0.3s ease' }} className="hover-card">
                <div style={{ fontFamily: 'Montserrat,sans-serif', fontWeight: 900, fontSize: 80, color: '#E5E7EB', lineHeight: 0.8, marginBottom: 24 }}>
                  {adv.num}
                </div>
                <h3 style={{ fontFamily: 'Montserrat,sans-serif', fontWeight: 700, fontSize: 32, marginBottom: 16 }}>{adv.title}</h3>
                <p style={{ fontFamily: 'Lexend,sans-serif', fontSize: 18, color: '#4B5563', lineHeight: 1.6 }}>{adv.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: '140px 0' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 40px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gridTemplateRows: 'auto auto', gap: 24 }} className="bento-grid">
            ...
            {/* Block 1 */}
            <div style={{ gridColumn: 'span 2', background: 'linear-gradient(135deg, #0A0C0F 0%, #F3F4F6 100%)', border: '1px solid #E5E7EB', borderRadius: 24, padding: 60, position: 'relative', overflow: 'hidden' }}>
              <div style={{ position: 'absolute', right: -50, top: -50, width: 200, height: 200, background: '#1F8844', filter: 'blur(100px)', opacity: 0.1 }} />
            ...
            {/* Block 2 */}
            <div style={{ gridColumn: 'span 1', background: '#1F8844', borderRadius: 24, padding: 60, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              <h3 style={{ fontFamily: 'Montserrat,sans-serif', fontWeight: 900, fontSize: 48, color: '#FFFFFF', lineHeight: 1.1, marginBottom: 16 }}>100%<br/>In-House</h3>
              <p style={{ fontFamily: 'Lexend,sans-serif', fontSize: 15, color: '#E5E7EB', fontWeight: 500 }}>We never outsource. Ever.</p>
            </div>

            {/* Block 3 */}
            <div style={{ gridColumn: 'span 1', background: '#F9FAFB', border: '1px solid #E5E7EB', borderRadius: 24, padding: 60 }}>
              <div style={{ fontSize: 40, marginBottom: 24 }}>🚀</div>
              <h3 style={{ fontFamily: 'Montserrat,sans-serif', fontWeight: 700, fontSize: 24, marginBottom: 12 }}>Scale-Ready</h3>
              <p style={{ fontFamily: 'Lexend,sans-serif', fontSize: 15, color: '#4B5563', lineHeight: 1.6 }}>Architectures designed to handle your first 1M users without breaking a sweat.</p>
            </div>

            {/* Block 4 */}
            <div style={{ gridColumn: 'span 2', background: '#0A0C0F', border: '1px solid #E5E7EB', borderRadius: 24, padding: 0, overflow: 'hidden', display: 'flex' }} className="split-bento">
              <div style={{ flex: 1, padding: 60 }}>
                ...
                <p style={{ fontFamily: 'Lexend,sans-serif', fontSize: 16, color: '#4B5563', lineHeight: 1.6 }}>We believe enterprise software shouldn't look like an Excel spreadsheet. We bring consumer-grade aesthetics to B2B platforms.</p>
              </div>
              <div style={{ flex: 1, background: 'url(/images/generic-1.png center/cover' }} className="bento-img" />
            </div>
      ...
      {/* 4. MASSIVE CTA */}
      <section style={{ padding: '140px 40px', textAlign: 'center', background: '#1F8844', color: '#FFFFFF' }}>
        ...
        <Link to="/contact" style={{ display: 'inline-block', background: '#FFFFFF', color: '#111827', padding: '20px 48px', fontFamily: 'Montserrat,sans-serif', fontWeight: 700, fontSize: 18, borderRadius: 100, textDecoration: 'none', transition: 'transform 0.2s', boxShadow: '0 20px 40px rgba(8,9,10,0.3)' }} onMouseEnter={e => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={e => e.currentTarget.style.transform = 'scale(1)'}>
          Talk to our team
        </Link>
      </section>
      ...
      <style>{`
        ...
        .hover-card:hover { border-color: #1F8844 !important; transform: translateX(-10px); }
