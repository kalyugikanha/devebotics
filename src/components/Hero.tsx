  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        <img
          src="https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b?w=1200&q=80&fit=crop"
          alt="Tech workspace"
          loading="eager"
        ...
        <div style={{
          ...
          background: 'linear-gradient(to right, #08090A 0%, rgba(8,9,10,0.6) 40%, transparent 100%)',
        }} />
      </div>
      ...
      {floatingTags.map((tag, i) => (
        <motion.div
          ...
          style={{
            ...
            color: '#3A3D42', background: '#0E1012',
        ...
        <div style={{ maxWidth: 640 }}>
          ...
          >
            <span style={{
              ...
              color: '#6B6F76', background: '#0E1012',
              border: '1px solid #1C1E21', borderRadius: 100,
              padding: '7px 16px',
            }}>
          ...
          <h1 style={{
            ...
            {words.map((word, i) => (
              <motion.span
                ...
                style={{ display: 'inline-block', marginRight: '0.22em', color: '#F0F0F0' }}
              >
                {word}
              </motion.span>
            ))}
            ...
            <motion.span
              ...
              style={{ display: 'inline-block', color: '#E8FF47' }}
            >
              Growth.
            </motion.span>
          </h1>
          ...
          <motion.p
            ...
            style={{
              ...
              fontSize: 18, color: '#6B6F76', maxWidth: 480,
          ...
          >
            ...
            <a href="#" style={{
              ...
              color: '#6B6F76', textDecoration: 'none',
          ...
          >
            <div style={{ height: 1, background: '#1C1E21', marginBottom: 24 }} />
            <div style={{ display: 'flex', gap: 40, flexWrap: 'wrap' }}>
              {[
                ...
                <div key={s.label}>
                  <div style={{
                    fontFamily: 'Montserrat, sans-serif', fontWeight: 900,
                    fontSize: 24, color: '#F0F0F0', letterSpacing: '-0.02em',
                  }}>
                    {s.val}
                  </div>
                  <div style={{
                    fontFamily: 'Lexend, sans-serif', fontWeight: 300,
                    fontSize: 12, color: '#6B6F76', letterSpacing: '0.08em',
      ...
      <div style={{
        ...
        width: 1, height: 48,
        background: 'linear-gradient(to bottom, transparent, #3A3D42)',
